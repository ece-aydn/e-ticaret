...
// Mock iş ilanları - Operasyon & Satış kategorisi için
const operationsJobs = [
  {
    id: "1",
    company: "Customer Success Co.",
    role: "Müşteri İlişkileri Temsilcisi",
    type: "Yarı zamanlı • Remote",
    tags: ["Müşteri Hizmetleri", "CRM", "İletişim", "Problem Çözme"],
    salary: "₺7.000-10.000",
    location: "Remote",
    urgent: true,
    description: "Müşteri sorularını yanıtlamak, destek sağlamak ve müşteri memnuniyetini artırmak için iletişim becerisi yüksek öğrenci arıyoruz.",
    requirements: ["İletişim becerileri", "Müşteri hizmetleri", "CRM kullanımı"],
  },
  {
    id: "2",
    company: "Sales Team Pro",
    role: "Satış Temsilcisi",
    type: "Yarı zamanlı • Hibrit",
    tags: ["Satış", "Müşteri İlişkileri", "Hedef Belirleme", "Pazarlama"],
    salary: "₺8.000-12.000 + Komisyon",
    location: "İstanbul",
    urgent: false,
    description: "Yeni müşteriler kazanmak, satış süreçlerini yönetmek ve satış hedeflerine ulaşmak için satış odaklı öğrenci arıyoruz.",
    requirements: ["Satış deneyimi", "İkna becerileri", "Hedef odaklı çalışma"],
  },
  {
    id: "3",
    company: "Field Operations",
    role: "Saha Operasyon Uzmanı",
    type: "Tam zamanlı • Kampüs",
    tags: ["Saha Operasyonları", "Lojistik", "Koordinasyon", "Saha Yönetimi"],
    salary: "₺9.000-13.000",
    location: "Ankara",
    urgent: true,
    description: "Saha operasyonlarını yönetmek, lojistik süreçleri koordine etmek ve saha ekiplerini yönetmek için organizasyon becerisi yüksek öğrenci arıyoruz.",
    requirements: ["Operasyon yönetimi", "Lojistik bilgisi", "Koordinasyon"],
  },
  {
    id: "4",
    ...
    type: "Yarı zamanlı • Remote",
    tags: ["İş Geliştirme", "Networking", "Strateji", "Pazarlama"],
    salary: "₺7.000-11.000",
    location: "Remote",
    urgent: false,
    description: "Yeni iş fırsatları bulmak, ortaklıklar kurmak ve iş geliştirme stratejileri oluşturmak için stratejik düşünme becerisi olan öğrenci arıyoruz.",
    requirements: ["İş geliştirme", "Networking", "Stratejik düşünme"],
  },
  {
    id: "5",
    company: "Retail Operations",
    role: "Perakende Satış Uzmanı",
    type: "Yarı zamanlı • Kampüs",
    tags: ["Perakende", "Satış", "Müşteri Hizmetleri", "Envanter"],
    salary: "₺6.000-9.000",
    location: "İzmir",
    urgent: false,
    description: "Perakende mağazada satış yapmak, müşterilere hizmet vermek ve envanter yönetimi yapmak için öğrenci arıyoruz.",
    requirements: ["Perakende deneyimi", "Satış becerileri", "Müşteri hizmetleri"],
  },
  {
    id: "6",
    ...
    type: "Yarı zamanlı • Hibrit",
    tags: ["Hesap Yönetimi", "Müşteri İlişkileri", "CRM", "Satış"],
    salary: "₺9.000-13.000",
    location: "İstanbul",
    urgent: true,
    description: "Mevcut müşteri hesaplarını yönetmek, müşteri ilişkilerini geliştirmek ve satış fırsatlarını değerlendirmek için öğrenci arıyoruz.",
    requirements: ["Hesap yönetimi", "CRM", "Müşteri ilişkileri"],
  },
  {
    id: "7",
    ...
    type: "Tam zamanlı • Kampüs",
    tags: ["Operasyon", "Koordinasyon", "Proje Yönetimi", "Lojistik"],
    salary: "₺8.000-12.000",
    location: "Bursa",
    urgent: false,
    description: "Günlük operasyonları koordine etmek, süreçleri optimize etmek ve ekip koordinasyonu sağlamak için organizasyon becerisi yüksek öğrenci arıyoruz.",
    requirements: ["Operasyon yönetimi", "Koordinasyon", "Proje yönetimi"],
  },
  {
    id: "8",
    company: "Sales Support",
    role: "Satış Destek Uzmanı",
    type: "Yarı zamanlı • Remote",
    tags: ["Satış Desteği", "CRM", "Raporlama", "Analiz"],
    salary: "₺6.000-9.000",
    location: "Remote",
    urgent: false,
    description: "Satış ekibine destek sağlamak, CRM verilerini yönetmek ve satış raporları hazırlamak için analitik düşünme becerisi olan öğrenci arıyoruz.",
    requirements: ["CRM kullanımı", "Raporlama", "Analitik düşünme"],
  },
  {
    id: "9",
    ...
    type: "Yarı zamanlı • Hibrit",
    tags: ["Müşteri Deneyimi", "UX", "Feedback", "İyileştirme"],
    salary: "₺7.000-10.000",
    location: "Ankara",
    urgent: true,
    description: "Müşteri deneyimini iyileştirmek, geri bildirimleri analiz etmek ve süreç iyileştirmeleri yapmak için müşteri odaklı öğrenci arıyoruz.",
    requirements: ["Müşteri deneyimi", "Analitik düşünme", "İyileştirme"],
  },
  {
    id: "10",
    company: "Inside Sales",
    role: "İç Satış Temsilcisi",
    type: "Yarı zamanlı • Remote",
    tags: ["İç Satış", "Telefon Satışı", "CRM", "Hedef Belirleme"],
    salary: "₺7.000-11.000 + Komisyon",
    location: "Remote",
    urgent: false,
    description: "Telefon ve online kanallar üzerinden satış yapmak, müşteri adaylarıyla iletişim kurmak ve satış hedeflerine ulaşmak için öğrenci arıyoruz.",
    requirements: ["Telefon satışı", "CRM", "Hedef odaklı çalışma"],
  },
];
...
export default function OperasyonSatisPage() {
  ...
  let jobsToFilter = operationsJobs;
  ...
  if (cityParam && workTypeParam) {
    ...
    jobsToFilter = operationsJobs.filter((job) => {
      // Şehir kontrolü
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 text-slate-900 dark:text-white overflow-hidden transition-colors duration-300">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-orange-500/10 dark:bg-orange-500/20 rounded-full blur-3xl animate-pulse" />
        <div className="absolute top-1/2 -left-40 w-80 h-80 bg-red-500/10 dark:bg-red-500/20 rounded-full blur-3xl animate-pulse delay-1000" />
        <div className="absolute -bottom-40 right-1/3 w-80 h-80 bg-orange-500/10 dark:bg-orange-500/20 rounded-full blur-3xl animate-pulse delay-2000" />
      </div>
      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col px-4 sm:px-6 lg:px-8 pb-16 pt-6">
        ...
        <main className="flex flex-1 flex-col gap-8">
          {/* Hero Section */}
          <section className="rounded-3xl border border-slate-200 dark:border-white/10 bg-gradient-to-br from-orange-100/50 to-red-100/50 dark:from-orange-500/10 dark:to-red-500/10 p-8 lg:p-12 backdrop-blur-xl">
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                <div className="inline-flex items-center gap-2 rounded-full border border-orange-400/30 bg-orange-50 dark:bg-orange-400/10 px-4 py-2 text-xs font-semibold uppercase tracking-wider text-orange-700 dark:text-orange-300 backdrop-blur-sm mb-4">
                  <span className="text-2xl">🤝</span>
                  Operasyon & Satış
                </div>
                <h1 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white mb-4">
                  Operasyon ve Satış Fırsatları
                </h1>
                <p className="text-lg text-slate-600 dark:text-slate-300 max-w-2xl">
                  Müşteri ilişkileri, saha operasyonları ve satış alanlarında kariyer yapmak isteyen öğrenciler için özel fırsatlar. 
                  İletişim becerilerinizi kullanın ve iş dünyasında deneyim kazanın.
                </p>
              </div>
              <Link
                href="/"
          ...
          <section className="grid gap-4 sm:grid-cols-4">
            ...
            <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm p-6 text-center">
              <div className="text-3xl mb-2">💼</div>
              <p className="text-2xl font-bold text-slate-900 dark:text-white mb-1">195</p>
              <p className="text-sm text-slate-600 dark:text-slate-400">Toplam Başvuru</p>
            </div>
            <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm p-6 text-center">
              <div className="text-3xl mb-2">⭐</div>
              <p className="text-2xl font-bold text-slate-900 dark:text-white mb-1">4.6</p>
              <p className="text-sm text-slate-600 dark:text-slate-400">Ortalama Puan</p>
            </div>
            <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm p-6 text-center">
              <div className="text-3xl mb-2">🚀</div>
              <p className="text-2xl font-bold text-slate-900 dark:text-white mb-1">88%</p>
          ...
          <section className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm p-6">
            ...
            <div className="flex flex-wrap gap-2">
              {["Müşteri İlişkileri", "Satış", "CRM", "Operasyon Yönetimi", "Lojistik", "Koordinasyon", "Networking", "İletişim", "Hesap Yönetimi", "Saha Operasyonları"].map((skill) => (
                <span
                  key={skill}
                  className="rounded-full bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 px-4 py-2 text-sm text-orange-700 dark:text-orange-300 font-medium"
                >
                  {skill}
                </span>
              ))}
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {filteredJobs.map((job) => (
                ...
                >
                  ...
                  <div className="mb-4">
                    <p className="text-xs font-semibold uppercase tracking-wider text-orange-600 dark:text-orange-300 mb-1">
                      {job.company}
                    </p>
                    ...
                    <p className="text-base font-bold text-orange-600 dark:text-orange-400 mb-3">
                      {job.salary}
                    </p>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {job.tags.map((tag) => (
                      <span
                        key={tag}
                        className="rounded-full bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 px-3 py-1 text-xs text-orange-700 dark:text-orange-300"
                      >
                        {tag}
                      </span>
                    ))}
                  ...
                  <Link
                    href={`/ilan/operasyon-satis-${job.id}`}
        ...
        <footer className="mt-12 flex flex-wrap items-center justify-between gap-4 border-t border-slate-200 dark:border-white/10 pt-8 text-sm text-slate-600 dark:text-slate-400">
          <div className="flex items-center gap-3">
            ...
            <p>© {new Date().getFullYear()} KariyerKöprü. Operasyon & Satış fırsatları.</p>
          </div>
