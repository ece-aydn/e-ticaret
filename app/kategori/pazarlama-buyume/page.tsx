...
// Mock iş ilanları - Pazarlama & Büyüme kategorisi için
const marketingJobs = [
  {
    id: "1",
    ...
    tags: ["Instagram", "TikTok", "Content Creation", "Analytics"],
    salary: "₺7.000-10.000",
    location: "Remote",
    urgent: true,
    description: "Sosyal medya hesaplarını yönetmek, içerik üretmek ve analitik raporlar hazırlamak için yaratıcı öğrenci arıyoruz.",
    requirements: ["Sosyal medya deneyimi", "İçerik üretimi", "Analitik düşünme"],
  },
  {
    id: "2",
    ...
    location: "İstanbul",
    urgent: false,
    description: "Blog yazıları, sosyal medya içerikleri ve pazarlama materyalleri için içerik üretecek yazma becerisi yüksek öğrenci arıyoruz.",
    requirements: ["Yazma becerisi", "SEO bilgisi", "Yaratıcılık"],
  },
  {
    id: "3",
    ...
    tags: ["Growth Hacking", "A/B Testing", "Analytics", "Conversion"],
    salary: "₺8.000-12.000",
    location: "Ankara",
    urgent: true,
    description: "Büyüme pazarlama stratejileri geliştirmek, A/B testleri yapmak ve dönüşüm oranlarını optimize etmek için analitik odaklı öğrenci arıyoruz.",
    requirements: ["Analitik düşünme", "A/B testing", "Growth hacking"],
  },
  {
    id: "4",
    ...
    type: "Yarı zamanlı • Remote",
    tags: ["Google Ads", "Facebook Ads", "PPC", "Campaign Management"],
    salary: "₺9.000-13.000",
    location: "Remote",
    urgent: false,
    description: "Google Ads ve Facebook Ads kampanyalarını yönetmek, reklam performansını optimize etmek için dijital pazarlama bilgisi olan öğrenci arıyoruz.",
    requirements: ["Google Ads/Facebook Ads", "PPC bilgisi", "Kampanya yönetimi"],
  },
  {
    id: "5",
    ...
    type: "Yarı zamanlı • Hibrit",
    tags: ["Influencer Relations", "Partnership", "Brand Collaboration", "KPI"],
    salary: "₺7.000-11.000",
    location: "İzmir",
    urgent: false,
    description: "Influencer'larla iş birliği yapmak, marka ortaklıkları kurmak ve kampanya sonuçlarını takip etmek için iletişim becerisi yüksek öğrenci arıyoruz.",
    requirements: ["İletişim becerileri", "Influencer marketing", "KPI takibi"],
  },
  {
    id: "6",
    ...
    type: "Yarı zamanlı • Remote",
    tags: ["Email Campaigns", "Automation", "Mailchimp", "CRM"],
    salary: "₺6.000-9.000",
    location: "Remote",
    urgent: false,
    description: "E-posta pazarlama kampanyaları oluşturmak, otomasyon kurmak ve e-posta performansını analiz etmek için öğrenci arıyoruz.",
    requirements: ["Email marketing", "Mailchimp/CRM", "Kampanya yönetimi"],
  },
  {
    id: "7",
    company: "SEO Agency",
    role: "SEO Specialist",
    type: "Yarı zamanlı • Remote",
    tags: ["SEO", "Keyword Research", "Google Analytics", "Technical SEO"],
    salary: "₺8.000-12.000",
    location: "Remote",
    urgent: true,
    description: "Web sitelerinin arama motoru optimizasyonunu yapmak, keyword araştırması yapmak ve SEO performansını takip etmek için öğrenci arıyoruz.",
    requirements: ["SEO bilgisi", "Google Analytics", "Keyword research"],
  },
  {
    id: "8",
    ...
    tags: ["Brand Strategy", "Brand Positioning", "Market Research", "Brand Identity"],
    salary: "₺9.000-14.000",
    location: "İstanbul",
    urgent: false,
    description: "Marka stratejisi geliştirmek, marka konumlandırması yapmak ve pazar araştırmaları yürütmek için stratejik düşünme becerisi olan öğrenci arıyoruz.",
    requirements: ["Marka stratejisi", "Pazar araştırması", "Stratejik düşünme"],
  },
  {
    id: "9",
    ...
    type: "Yarı zamanlı • Remote",
    tags: ["Performance Analytics", "ROI", "Data Analysis", "Reporting"],
    salary: "₺7.000-11.000",
    location: "Remote",
    urgent: true,
    description: "Pazarlama kampanyalarının performansını analiz etmek, ROI hesaplamak ve raporlama yapmak için veri analizi bilgisi olan öğrenci arıyoruz.",
    requirements: ["Veri analizi", "ROI hesaplama", "Raporlama"],
  },
  {
    id: "10",
    ...
    type: "Yarı zamanlı • Hibrit",
    tags: ["Video Editing", "YouTube", "Short-form Video", "Content Strategy"],
    salary: "₺6.000-10.000",
    location: "Bursa",
    urgent: false,
    description: "Video içerikleri üretmek, düzenlemek ve video pazarlama stratejileri geliştirmek için video editörlük becerisi olan öğrenci arıyoruz.",
    requirements: ["Video editing", "Content creation", "Video stratejisi"],
  },
];
...
export default function PazarlamaBuyumePage() {
  ...
  let jobsToFilter = marketingJobs;
  ...
  if (cityParam && workTypeParam) {
    ...
    jobsToFilter = marketingJobs.filter((job) => {
      // Şehir kontrolü
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 text-slate-900 dark:text-white overflow-hidden transition-colors duration-300">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 -left-40 w-80 h-80 bg-emerald-500/10 dark:bg-emerald-500/20 rounded-full blur-3xl animate-pulse delay-1000" />
        <div className="absolute -bottom-40 right-1/3 w-80 h-80 bg-green-500/10 dark:bg-green-500/20 rounded-full blur-3xl animate-pulse delay-2000" />
      </div>
      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col px-4 sm:px-6 lg:px-8 pb-16 pt-6">
        ...
        <main className="flex flex-1 flex-col gap-8">
          {/* Hero Section */}
          <section className="rounded-3xl border border-slate-200 dark:border-white/10 bg-gradient-to-br from-green-100/50 to-emerald-100/50 dark:from-green-500/10 dark:to-emerald-500/10 p-8 lg:p-12 backdrop-blur-xl">
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                <div className="inline-flex items-center gap-2 rounded-full border border-green-400/30 bg-green-50 dark:bg-green-400/10 px-4 py-2 text-xs font-semibold uppercase tracking-wider text-green-700 dark:text-green-300 backdrop-blur-sm mb-4">
                  <span className="text-2xl">📈</span>
                  Pazarlama & Büyüme
                </div>
                <h1 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white mb-4">
                  Pazarlama ve Büyüme Fırsatları
                </h1>
                <p className="text-lg text-slate-600 dark:text-slate-300 max-w-2xl">
                  Sosyal medya, içerik üretimi ve performans pazarlama alanlarında kariyer yapmak isteyen öğrenciler için özel fırsatlar. 
                  Yaratıcılığınızı kullanın ve markaları büyütün.
                </p>
              </div>
              <Link
                href="/"
          ...
          <section className="grid gap-4 sm:grid-cols-4">
            <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm p-6 text-center">
              ...
              <p className="text-2xl font-bold text-slate-900 dark:text-white mb-1">36</p>
              <p className="text-sm text-slate-600 dark:text-slate-400">Aktif İlan</p>
            </div>
            <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm p-6 text-center">
              <div className="text-3xl mb-2">💼</div>
              <p className="text-2xl font-bold text-slate-900 dark:text-white mb-1">289</p>
            ...
            <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm p-6 text-center">
              <div className="text-3xl mb-2">🚀</div>
              <p className="text-2xl font-bold text-slate-900 dark:text-white mb-1">91%</p>
          ...
          <section className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm p-6">
            ...
            <div className="flex flex-wrap gap-2">
              {["Sosyal Medya", "Content Creation", "SEO", "Google Ads", "Facebook Ads", "Analytics", "Email Marketing", "Influencer Marketing", "Growth Hacking", "Brand Strategy"].map((skill) => (
                <span
                  key={skill}
                  className="rounded-full bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 px-4 py-2 text-sm text-green-700 dark:text-green-300 font-medium"
                >
                  {skill}
                </span>
              ))}
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {filteredJobs.map((job) => (
                ...
                >
                  ...
                  <div className="mb-4">
                    <p className="text-xs font-semibold uppercase tracking-wider text-green-600 dark:text-green-300 mb-1">
                      {job.company}
                    </p>
                    ...
                    <p className="text-base font-bold text-green-600 dark:text-green-400 mb-3">
                      {job.salary}
                    </p>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {job.tags.map((tag) => (
                      <span
                        key={tag}
                        className="rounded-full bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 px-3 py-1 text-xs text-green-700 dark:text-green-300"
                      >
                        {tag}
                      </span>
                    ))}
                  ...
                  <Link
                    href={`/ilan/pazarlama-buyume-${job.id}`}
        ...
        <footer className="mt-12 flex flex-wrap items-center justify-between gap-4 border-t border-slate-200 dark:border-white/10 pt-8 text-sm text-slate-600 dark:text-slate-400">
          <div className="flex items-center gap-3">
            ...
            <p>© {new Date().getFullYear()} KariyerKöprü. Pazarlama & Büyüme fırsatları.</p>
          </div>
