...
// Mock iş ilanları - Dil Eğitimi kategorisi için
const languageJobs = [
  {
    id: "1",
    ...
    tags: ["İngilizce", "Öğretmenlik", "Eğitim", "Online"],
    salary: "₺8.000-12.000",
    location: "İstanbul",
    urgent: true,
    description: "İngilizce dil eğitimi vermek, öğrencilere dil öğretmek ve eğitim materyalleri hazırlamak için deneyimli öğrenci arıyoruz.",
    requirements: ["İngilizce yeterliliği", "Öğretmenlik deneyimi", "İletişim becerileri"],
  },
  {
    id: "2",
    company: "Translation Services",
    role: "Çevirmen (İngilizce-Türkçe)",
    type: "Yarı zamanlı • Remote",
    tags: ["Çeviri", "İngilizce", "Türkçe", "Yazılı Çeviri"],
    salary: "₺6.000-10.000",
    location: "Remote",
    urgent: false,
    description: "İngilizce-Türkçe çeviri yapmak, belgeleri çevirmek ve çeviri kalitesini kontrol etmek için çeviri deneyimi olan öğrenci arıyoruz.",
    requirements: ["İngilizce-Türkçe çeviri", "Dil bilgisi", "Dikkat"],
  },
  {
    id: "3",
    company: "Online Language School",
    role: "Online Dil Öğretmeni",
    type: "Yarı zamanlı • Remote",
    tags: ["Online Eğitim", "Dil Öğretimi", "Zoom", "E-Learning"],
    salary: "₺7.000-11.000",
    location: "Remote",
    urgent: true,
    description: "Online platform üzerinden dil eğitimi vermek, öğrencilerle video konferans yapmak ve dijital eğitim materyalleri kullanmak için öğrenci arıyoruz.",
    requirements: ["Online eğitim deneyimi", "Dil öğretimi", "Teknoloji kullanımı"],
  },
  {
    id: "4",
    company: "Language Exchange",
    role: "Dil Değişim Koordinatörü",
    type: "Yarı zamanlı • Kampüs",
    tags: ["Dil Değişimi", "Koordinasyon", "Etkinlik", "Networking"],
    salary: "₺5.000-8.000",
    location: "Ankara",
    urgent: false,
    description: "Dil değişim programlarını koordine etmek, etkinlikler düzenlemek ve öğrencileri eşleştirmek için organizasyon becerisi olan öğrenci arıyoruz.",
    requirements: ["Koordinasyon", "Etkinlik organizasyonu", "İletişim"],
  },
  {
    id: "5",
    company: "Multilingual Services",
    role: "Çok Dilli Destek Uzmanı",
    type: "Yarı zamanlı • Remote",
    tags: ["Çok Dilli", "Müşteri Desteği", "Çeviri", "İletişim"],
    salary: "₺7.000-10.000",
    location: "Remote",
    urgent: false,
    description: "Birden fazla dilde müşteri desteği sağlamak, çeviri yapmak ve çok dilli iletişim kurmak için dil bilgisi olan öğrenci arıyoruz.",
    requirements: ["Çok dilli", "Müşteri hizmetleri", "İletişim"],
  },
  {
    id: "6",
    company: "Language Testing Center",
    role: "Dil Sınavı Gözetmeni",
    type: "Proje bazlı • Kampüs",
    tags: ["Sınav Gözetmenliği", "Dil Sınavları", "TOEFL", "IELTS"],
    salary: "₺4.000-6.000",
    location: "İzmir",
    urgent: true,
    description: "Dil sınavlarında gözetmenlik yapmak, sınav süreçlerini yönetmek ve sınav sonuçlarını değerlendirmek için öğrenci arıyoruz.",
    requirements: ["Sınav gözetmenliği", "Dil sınavları bilgisi", "Dikkat"],
  },
  {
    id: "7",
    company: "Content Translation",
    role: "İçerik Çevirmeni",
    type: "Yarı zamanlı • Remote",
    tags: ["İçerik Çevirisi", "SEO", "Web Çevirisi", "Lokalizasyon"],
    salary: "₺6.000-9.000",
    location: "Remote",
    urgent: false,
    description: "Web içeriklerini çevirmek, SEO uyumlu çeviriler yapmak ve içerik lokalizasyonu yapmak için çeviri deneyimi olan öğrenci arıyoruz.",
    requirements: ["İçerik çevirisi", "SEO bilgisi", "Web çevirisi"],
  },
  {
    id: "8",
    company: "Language Tutoring",
    role: "Özel Dil Öğretmeni",
    type: "Yarı zamanlı • Hibrit",
    tags: ["Özel Ders", "Birebir Eğitim", "Dil Öğretimi", "Esnek Çalışma"],
    salary: "₺9.000-14.000",
    location: "İstanbul",
    urgent: true,
    description: "Birebir dil eğitimi vermek, öğrencilere özel ders planları hazırlamak ve esnek çalışma saatleriyle çalışmak için öğrenci arıyoruz.",
    requirements: ["Özel ders deneyimi", "Dil öğretimi", "Esnek çalışma"],
  },
  {
    id: "9",
    company: "International Relations",
    role: "Uluslararası İletişim Uzmanı",
    type: "Yarı zamanlı • Remote",
    tags: ["Uluslararası İletişim", "Çok Dilli", "Kültürlerarası", "Diplomasi"],
    salary: "₺8.000-12.000",
    location: "Remote",
    urgent: false,
    description: "Uluslararası iletişim kurmak, çok dilli projelerde görev almak ve kültürlerarası iletişimi yönetmek için dil ve iletişim becerisi olan öğrenci arıyoruz.",
    requirements: ["Uluslararası iletişim", "Çok dilli", "Kültürlerarası bilgi"],
  },
  {
    id: "10",
    company: "Language Learning App",
    role: "Dil Öğrenme İçerik Üreticisi",
    type: "Yarı zamanlı • Remote",
    tags: ["İçerik Üretimi", "E-Learning", "Dil Materyalleri", "Yaratıcılık"],
    salary: "₺7.000-11.000",
    location: "Remote",
    urgent: true,
    description: "Dil öğrenme uygulamaları için içerik üretmek, eğitim materyalleri hazırlamak ve yaratıcı dil öğrenme içerikleri oluşturmak için öğrenci arıyoruz.",
    requirements: ["İçerik üretimi", "E-learning", "Yaratıcılık"],
  },
];
...
export default function DilEgitimiPage() {
  ...
  if (cityParam && workTypeParam) {
    ...
    jobsToFilter = languageJobs.filter((job) => {
      // Şehir kontrolü
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 text-slate-900 dark:text-white overflow-hidden transition-colors duration-300">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-40 right-1/3 w-80 h-80 bg-teal-500/10 dark:bg-teal-500/20 rounded-full blur-3xl animate-pulse delay-2000" />
      </div>
      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col px-4 sm:px-6 lg:px-8 pb-16 pt-6">
        ...
        <main className="flex flex-1 flex-col gap-8">
          {/* Hero Section */}
          <section className="rounded-3xl border border-slate-200 dark:border-white/10 bg-gradient-to-br from-teal-100/50 to-cyan-100/50 dark:from-teal-500/10 dark:to-cyan-500/10 p-8 lg:p-12 backdrop-blur-xl">
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                <div className="inline-flex items-center gap-2 rounded-full border border-teal-400/30 bg-teal-50 dark:bg-teal-400/10 px-4 py-2 text-xs font-semibold uppercase tracking-wider text-teal-700 dark:text-teal-300 backdrop-blur-sm mb-4">
                  <span className="text-2xl">🌍</span>
                  Dil Eğitimi
                </div>
                <h1 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white mb-4">
                  Dil Eğitimi ve Çeviri Fırsatları
                </h1>
                <p className="text-lg text-slate-600 dark:text-slate-300 max-w-2xl">
                  Yabancı dil öğretimi, çeviri ve dil eğitimi alanlarında kariyer yapmak isteyen öğrenciler için özel fırsatlar. 
                  Dillerinizi kullanın ve kültürler arası köprü olun.
                </p>
              </div>
              <Link
                href="/"
          ...
          <section className="grid gap-4 sm:grid-cols-4">
            <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm p-6 text-center">
              ...
              <p className="text-2xl font-bold text-slate-900 dark:text-white mb-1">31</p>
              <p className="text-sm text-slate-600 dark:text-slate-400">Aktif İlan</p>
            </div>
            <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm p-6 text-center">
              <div className="text-3xl mb-2">💼</div>
              <p className="text-2xl font-bold text-slate-900 dark:text-white mb-1">223</p>
            ...
            <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm p-6 text-center">
              <div className="text-3xl mb-2">🚀</div>
              <p className="text-2xl font-bold text-slate-900 dark:text-white mb-1">93%</p>
          ...
          <section className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm p-6">
            <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-4">Popüler Diller ve Yetenekler</h3>
            <div className="flex flex-wrap gap-2">
              {["İngilizce", "Almanca", "Fransızca", "İspanyolca", "Çeviri", "Öğretmenlik", "Online Eğitim", "Lokalizasyon", "Dil Değişimi", "Çok Dilli İletişim"].map((skill) => (
                <span
                  key={skill}
                  className="rounded-full bg-teal-50 dark:bg-teal-900/20 border border-teal-200 dark:border-teal-800 px-4 py-2 text-sm text-teal-700 dark:text-teal-300 font-medium"
                >
                  {skill}
                </span>
              ))}
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {filteredJobs.map((job) => (
                ...
                >
                  ...
                  <div className="mb-4">
                    <p className="text-xs font-semibold uppercase tracking-wider text-teal-600 dark:text-teal-300 mb-1">
                      {job.company}
                    </p>
                    ...
                    <p className="text-base font-bold text-teal-600 dark:text-teal-400 mb-3">
                      {job.salary}
                    </p>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {job.tags.map((tag) => (
                      <span
                        key={tag}
                        className="rounded-full bg-teal-50 dark:bg-teal-900/20 border border-teal-200 dark:border-teal-800 px-3 py-1 text-xs text-teal-700 dark:text-teal-300"
                      >
                        {tag}
                      </span>
                    ))}
        ...
        <footer className="mt-12 flex flex-wrap items-center justify-between gap-4 border-t border-slate-200 dark:border-white/10 pt-8 text-sm text-slate-600 dark:text-slate-400">
          <div className="flex items-center gap-3">
            ...
            <p>© {new Date().getFullYear()} KariyerKöprü. Dil Eğitimi fırsatları.</p>
          </div>
